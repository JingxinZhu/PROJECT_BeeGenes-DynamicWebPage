#!/usr/bin/env python
'''
File: localCGIServer.py
------------------------------------------------------
Run a local cgi server from the current directory that 
treats *.cgi files as executable python cgi scripts.

By : Xiaolong Yang @ Cornell University
------------------------------------------------------
'''
